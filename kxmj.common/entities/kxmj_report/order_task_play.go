...
func (o *OrderTaskPlay) TableName() string {
	return "order_task_play"
}

func (o *OrderTaskPlay) Schema() string {
	return "kxmj_report"
}

func (o *OrderTaskPlay) MarshalBinary() ([]byte, error) {
	return json.Marshal(o)
}

func (o *OrderTaskPlay) UnmarshalBinary(data []byte) error {
