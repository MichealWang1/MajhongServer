...
func (o *OrderTaskLogin) TableName() string {
	return "order_task_login"
}

func (o *OrderTaskLogin) Schema() string {
	return "kxmj_report"
}

func (o *OrderTaskLogin) MarshalBinary() ([]byte, error) {
	return json.Marshal(o)
}

func (o *OrderTaskLogin) UnmarshalBinary(data []byte) error {
