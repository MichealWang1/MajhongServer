...
type TaskWin struct {
	...
	Condition string `json:"condition" redis:"condition" gorm:"column:condition"`       // 赢金豆达到条件
...
func (t *TaskWin) TableName() string {
	return "task_win"
}

func (t *TaskWin) Schema() string {
	return "kxmj_core"
}

func (t *TaskWin) MarshalBinary() ([]byte, error) {
	return json.Marshal(t)
}

func (t *TaskWin) UnmarshalBinary(data []byte) error {
