...
func (m *MjxlchUserRecord) TableName() string {
	return "mjxlch_user_record"
}

func (m *MjxlchUserRecord) Schema() string {
	return "kxmj_game"
}

func (m *MjxlchUserRecord) MarshalBinary() ([]byte, error) {
	return json.Marshal(m)
}

func (m *MjxlchUserRecord) UnmarshalBinary(data []byte) error {
