...
func (g *GameRoundRecord) TableName() string {
	return "game_round_record"
}

func (g *GameRoundRecord) Schema() string {
	return "kxmj_game"
}

func (g *GameRoundRecord) MarshalBinary() ([]byte, error) {
	return json.Marshal(g)
}

func (g *GameRoundRecord) UnmarshalBinary(data []byte) error {
