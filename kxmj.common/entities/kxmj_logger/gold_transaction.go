...
func (g *GoldTransaction) TableName() string {
	return "gold_transaction"
}

func (g *GoldTransaction) Schema() string {
	return "kxmj_logger"
}

func (g *GoldTransaction) MarshalBinary() ([]byte, error) {
	return json.Marshal(g)
}

func (g *GoldTransaction) UnmarshalBinary(data []byte) error {
