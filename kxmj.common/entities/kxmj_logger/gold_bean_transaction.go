...
type GoldBeanTransaction struct {
...
func (g *GoldBeanTransaction) TableName() string {
	return "gold_bean_transaction"
}

func (g *GoldBeanTransaction) Schema() string {
	return "kxmj_logger"
}

func (g *GoldBeanTransaction) MarshalBinary() ([]byte, error) {
	return json.Marshal(g)
}

func (g *GoldBeanTransaction) UnmarshalBinary(data []byte) error {
