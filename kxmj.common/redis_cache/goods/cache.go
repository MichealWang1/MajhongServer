...
import (
	...
	"kxmj.common/redis_cache/goods/detail"
...
type Cache struct {
	...
	continueCache *continue_goods.Cache // 首充连续领取礼包缓存
}
...
func NewCache(client *redis.Client, handler *redis_core.Handler, register *redis_core.Register) *Cache {
	...
	temp.continueCache = continue_goods.NewCache(client)
...
func (c *Cache) GetContinueCache() *continue_goods.Cache {
	return c.continueCache
}
